...
namespace Game {
    ...
    public static class Settings {
        ...
        public static class Tiles {
            ...
            public static TileDefinition Coal = new TileDefinition {FuelAmount = 300f, Drillable = true, ScoreAmount = 25, TimeToDrill = 0.25f, Texture = Texture2D.GetInstance("data/coal.png")};
            ...
            public static TileDefinition Emerald = new TileDefinition {Drillable = true, ScoreAmount = 150, TimeToDrill = 0.75f, Texture = Texture2D.GetInstance("data/emerald.png")};
            public static TileDefinition Sapphire = new TileDefinition {Drillable = true, ScoreAmount = 300, TimeToDrill = 1f, Texture = Texture2D.GetInstance("data/sapphire.png")};
